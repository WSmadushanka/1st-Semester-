package lk.ijse.gdse71.nl.nltecnologies.util;
...
public class Regex {
    ...
    public static boolean setTextColor(TextField location, javafx.scene.control.TextField textField){
        if (Regex.isTextFieldValid(location, textField.getText())){
            textField.setStyle("-fx-border-color: #2505f3; -fx-text-fill: #070606;  -fx-border-radius: 5px; -fx-border-width:  2px 2px 2px 2px; -fx-background-radius: 5px;");
